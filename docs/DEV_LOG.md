...
- Scos butonul "Switch"/căutarea de sesiuni din `SessionPicker` — ca să continui o sesiune veche, apeși direct pe titlul ei din istoric (`WorkoutHistory`), care o face sesiunea curentă.
