...
- Cele 4 categorii de urmărit (Reps/Weight/Time/Distance) nu mai sunt fixe — buton "+ Add" în `ExerciseForm` lasă utilizatorul să definească propriile categorii (nume + unitate opțională), persistate prin `useFieldTypes`.
