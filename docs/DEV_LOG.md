...
- Exercițiile nu erau editabile după creare (doar ștergere). `ExerciseForm` e acum reutilizabil pentru creare și editare; buton "Edit" pe fiecare exercițiu îl deschide inline, pre-completat, cu `useExercises.updateExercise`.
