...
interface SessionCardProps { session:WorkoutSession; entries:WorkoutEntry[]; isOpen:boolean; exercises:Exercise[]; fieldTypes:FieldType[]; historyFieldTypes:FieldType[]; getLastEntry:(exerciseId:string)=>WorkoutEntry|undefined; onToggle:()=>void; onUpdateSession:(date:string,name:string)=>boolean; onFinishSession?:()=>boolean; onAddEntry:(entry:NewExerciseEntry)=>boolean; onUpdateEntry:(entryId:string,entry:NewExerciseEntry)=>boolean; onDeleteEntry?:(entryId:string)=>boolean }

export function SessionCard({ session, entries, isOpen, exercises, fieldTypes, historyFieldTypes, getLastEntry, onToggle, onUpdateSession, onFinishSession, onAddEntry, onUpdateEntry, onDeleteEntry }: SessionCardProps) {
