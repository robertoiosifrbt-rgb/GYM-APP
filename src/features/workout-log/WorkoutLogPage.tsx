...
export function WorkoutLogPage() {
  ...
  return <section className="workout-log-page">
    ...
    <div className="module-toolbar"><div><span className="card-kicker">{sessions.length} {sessions.length === 1 ? 'WORKOUT' : 'WORKOUTS'}</span><h2>Daily log</h2></div><button type="button" className="primary-action" onClick={() => setCreating((value) => !value)}>{creating ? 'Close' : '+ New session'}</button></div>
